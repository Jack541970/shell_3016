...
<head>
  ...
  <head>
    <title>Télécharger et enregistrer dans la base de données</title>
  </head>
  ...
  <br>
  <br>
  <h1 class="titre_marge-gauche">Formulaire de téléchargement et de suppression des fichiers ACCIDENTS</h1>
  <br>
